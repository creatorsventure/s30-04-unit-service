...
@RestController
@RequestMapping(UnitConstant.APP_NAVIGATION_API_BIN)
@AllArgsConstructor
@Slf4j
public class BinController implements GenericController<BinDto> {
    private BinService service;

    @PostMapping
    @Override
    public ResponseEntity<Object> create(@RequestBody @Valid BinDto dto, BindingResult result) {
        try {
            if (result.hasErrors()) {
                log.info("BinController.create {}", result.getAllErrors());
            ...
            log.error("BinController.create {}", ExceptionUtils.getStackTrace(e));
    ...
    @PutMapping
    @Override
    public ResponseEntity<Object> update(@RequestBody @Valid BinDto dto, BindingResult result) {
        try {
            if (result.hasErrors()) {
                log.info("BinController.update {}", result.getAllErrors());
                return StaticUtil.getFailureResponse(result);
            }
            return StaticUtil.getSuccessResponse(service.update(dto), APIResponseType.OBJECT_ONE);
        } catch (Exception e) {
            log.error("BinController.update {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> updateStatus(@RequestParam String id, @RequestParam boolean status) {
        try {
            ...
            log.error("BinController.updateStatus {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> readOne(@RequestParam String id) {
        try {
            log.info("BinController.readOne {}", id);
            return StaticUtil.getSuccessResponse(service.readOne(id), APIResponseType.OBJECT_ONE);
        } catch (Exception e) {
            log.error("BinController.readOne {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> readPage(@RequestBody PaginationDto dto) {
        try {
            ...
            log.error("BinController.readPage {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> readIdNameMapping() {
        try {
            ...
            log.error("BinController.readIdNameMapping {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> delete(@RequestParam String id) {
        try {
            ...
            log.error("BinController.delete {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
