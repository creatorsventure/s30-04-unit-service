...
@RestController
@RequestMapping(UnitConstant.APP_NAVIGATION_API_UNIT_KEY)
@AllArgsConstructor
@Slf4j
public class UnitKeyController implements GenericController<UnitKeyDto> {
    private UnitKeyService service;

    @PostMapping
    @Override
    public ResponseEntity<Object> create(@RequestBody @Valid UnitKeyDto dto, BindingResult result) {
        try {
            if (result.hasErrors()) {
                log.info("UnitKeyController.create {}", result.getAllErrors());
            ...
            log.error("UnitKeyController.create {}", ExceptionUtils.getStackTrace(e));
    ...
    @PutMapping
    @Override
    public ResponseEntity<Object> update(@RequestBody @Valid UnitKeyDto dto, BindingResult result) {
        try {
            if (result.hasErrors()) {
                log.info("UnitKeyController.update {}", result.getAllErrors());
                return StaticUtil.getFailureResponse(result);
            }
            return StaticUtil.getSuccessResponse(service.update(dto), APIResponseType.OBJECT_ONE);
        } catch (Exception e) {
            log.error("UnitKeyController.update {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> updateStatus(@RequestParam String id, @RequestParam boolean status) {
        try {
            ...
            log.error("UnitKeyController.updateStatus {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> readOne(@RequestParam String id) {
        try {
            log.info("UnitKeyController.readOne {}", id);
            return StaticUtil.getSuccessResponse(service.readOne(id), APIResponseType.OBJECT_ONE);
        } catch (Exception e) {
            log.error("UnitKeyController.readOne {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> readPage(@RequestBody PaginationDto dto) {
        try {
            ...
            log.error("UnitKeyController.readPage {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> readIdNameMapping() {
        try {
            ...
            log.error("UnitKeyController.readIdNameMapping {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
    ...
    public ResponseEntity<Object> delete(@RequestParam String id) {
        try {
            ...
            log.error("UnitKeyController.delete {}", ExceptionUtils.getStackTrace(e));
            return StaticUtil.getFailureResponse(e);
        }
    }
}
